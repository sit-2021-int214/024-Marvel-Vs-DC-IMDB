...
prog_book %>% select(Book_title , Number_Of_Pages , Price) %>% filter(prog_book$Number_Of_Pages > 300)%>% arrange(data.frame(Price)) %>% head()
```
#### Result:
```
> sum(prog_book$Number_Of_Pages > 300)
...
1  The Information: A History, a Theory, a Flood                                                  527           11.00000
2  Ghost in the Wires: My Adventures as the World's Most Wanted Hacker                            393           12.87353
3  How Google Works                                                                               305           13.16471
4  Algorithms to Live By: The Computer Science of Human Decisions                                 368           14.36471
5  Sync: The Emerging Science of Spontaneous Order                                                352           15.22941
6  The Master Algorithm: How the Quest for the Ultimate Learning Machine Will Remake Our World    352           15.22941
```
#### Explain
```
```
